...
<p>Experience (years): <input type="text" name="experience" size="30" value= "<?php if($experience!=0) print "$experience" ?>"/></p>
<p>Soundcloud Profile Link <input type="text" name="sclink" size="30" value= "<?php print "$sclink" ?>"/></p>
