...
if(isset($_POST['create'])){
	...
	if($numrows>=5){
		echo "Sorry, you may only create 5 total bands.";
	}
	else{
		...
		if (mysqli_num_rows($query) != 0)
			echo "Band name already in use!";
				...
				// create band
				$sql="INSERT INTO bands (id, name, location, genre, band_leader, member1, member2, member3, member4, member5, member6, member7, member8, member9, member10, bandpic) VALUES (NULL,'$bandname','$location', '$genre','$logged_in_user','','','','','','','','','','','')";
				...
				echo "Band successfully created";
		}
	}
}
...
<p><input type="text" name="location" size="30" placeholder="Location (City, State)"/></p>
